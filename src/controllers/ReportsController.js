...
export class ReportsController {
  ...
  static getExecutiveSummary = asyncHandler(async (req, res) => {
    ...
    // Mapear campos a nombres esperados por el frontend (PascalCase)
    const normalized = normalizeBDResponse(result);
    const mapped = {
      TotalVentas: normalized.totalVentasMoneda || 0,
      CantidadTransacciones: normalized.totalVentas || 0,
      TicketPromedio: normalized.ticketPromedio || 0,
      ProductosVendidos: normalized.productosVendidos || 0,
      totalSales: normalized.totalVentas || 0,
      totalRevenue: normalized.totalVentasMoneda || 0,
      ...normalized
    };
